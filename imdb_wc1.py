...
for link in soup.find_all('td',{'class':'titleColumn'}):
	...
	#try and get rid of: prints name of location but also '7 of 7 found this interesting'
	for loc_link in location_soup.find_all('div',{'id':'filming_locations_content'}):
		for text_block in loc_link.find_all('div',{'class':'soda sodavote even'}):
			for i in text_block.find_all('a'):
				print (i.contents[0])
print ('done')
